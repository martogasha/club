...
Route::get('hotelAdmin', [\App\Http\Controllers\AdminController::class, 'hotelAdmin']);
...
Route::post('filterMpesa', [\App\Http\Controllers\AdminController::class, 'filterMpesa']);
