...
<!-- Mirrored from bootstrap.gallery/unipro/v1-x/01-design-blue/reports.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Aug 2021 04:46:41 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="earnings-detail">
                                            <div class="earnings-info">
                                                <p class="text-lighter"><b style="font-size: 20px;color: #0b0e23">Club Name</b></p>
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" >
                                                <div class="image-stats-tile">
                                                    ...
                                                    <div class="weekly-graph-details">
                                                        <button class="btn btn-outline-dark">6Pack</button>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card h-475">
                                    ...
                                    <div class="card-body pt-0" style="height: 300px;overflow: auto">
                                        ...
                                        <div class="earnings-detail">
                                            <div class="earnings-info">
                                                <p class="text-lighter"><b style="font-size: 20px;color: #0b0e23">Table 1</b></p>
                                                <h5 class="text-danger">Orders</h5>
                                            </div>
                                            <div>
                                                <p style="font-size: 20px"><b>50000 /=</b></p>
                                            ...
                                            <table class="table products-table">
                                                ...
                                                <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><button class="btn btn-warning btn-sm">-</button> <b>10</b> <button class="btn btn-success btn-sm">+</button></td>
                                                        <td>385 /=</td>
                                                        <td><b>385 /=</b></td>
                                                    ...
                                                    <tr>
                                                        <td><button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">Pay</button>
                                                        </td>
                                                        <td></td>
                                                        <td></td>
                                                        <td><b style="font-size: 20px">385 /=</b></td>
                                                    </tr>
